...
inline void spdlog::logger::log(source_loc source, level::level_enum lvl,
	...
	try {
		details::log_msg log_msg(source, &name_, lvl,
...
inline spdlog::level::level_enum spdlog::logger::flush_level() const {
	return static_cast<spdlog::level::level_enum>(flush_level_.load(
...
inline spdlog::level::level_enum spdlog::logger::level() const {
	return static_cast<spdlog::level::level_enum>(level_.load(
			std::memory_order_relaxed));
}
...
inline std::shared_ptr<spdlog::logger> spdlog::logger::clone(
	...
	auto cloned = std::make_shared < spdlog::logger
			> (std::move(logger_name), sinks_.begin(), sinks_.end());
