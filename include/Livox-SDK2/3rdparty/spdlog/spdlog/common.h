...
#define SPDLOG_FUNCTION __FUNCTION__
		...
		using log_clock = std::chrono::system_clock; using sink_ptr = std::shared_ptr<sinks::sink>; using sinks_init_list = std::initializer_list<sink_ptr>; using log_err_handler = std::function<void(const std::string &err_msg)>;
...
// Log level enum
		namespace level { enum level_enum { trace = SPDLOG_LEVEL_TRACE,
