...
struct daily_filename_calculator {
	...
	static filename_t calc_filename(const filename_t &filename,
		...
		std::tie(basename, ext) = details::file_helper::split_by_extension(
				filename);
...
public:
	...
	daily_file_sink(filename_t base_filename, int rotation_hour,
			...
			base_filename_(std::move(base_filename)), rotation_h_(
					rotation_hour), rotation_m_(rotation_minute), truncate_(
					truncate) {
